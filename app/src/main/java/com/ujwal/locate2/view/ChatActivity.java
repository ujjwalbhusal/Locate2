...
import com.ujwal.locate2.view.leave.ViewAttendanceByEmployeeActivity;
...
public class ChatActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        }else if (id == R.id.attendemployee) {
            Intent intent = new Intent(ChatActivity.this, ViewAttendanceByEmployeeActivity.class);
