...
import com.ujwal.locate2.view.SettingsActivity;
...
public class RequestFragment extends Fragment {
    ...
    public void onStart() {
        ...
        FirebaseRecyclerOptions<LeaveHelper> recyclerOptions = new FirebaseRecyclerOptions.Builder<LeaveHelper>()
                .setQuery(databaseReference, LeaveHelper.class)
                .build();

        FirebaseRecyclerAdapter<LeaveHelper, RequestsVH> adapter = new FirebaseRecyclerAdapter<LeaveHelper, RequestsVH>(recyclerOptions) {
            @Override
            protected void onBindViewHolder(@NonNull final RequestsVH holder, int position, @NonNull LeaveHelper model) {
...
//                                        }
                                    ...
                                    public void onDataChange(DataSnapshot dataSnapshot) {
                                        ...
                                        if(!userThumbPhoto.equals("default_image")) { // default image condition for new user
                                            Picasso.get()
                                                    .load(userThumbPhoto)
                                                    .networkPolicy(NetworkPolicy.OFFLINE) // for Offline
                                                    .placeholder(R.drawable.realtime_hajiri)
                                                    .into(holder.user_photo, new Callback() {
                                                        @Override
                                                        public void onSuccess() {
                                                        }
                                            ...
                                            public void onClick(View v) {
                                                ...
                                                builder.setItems(options, new DialogInterface.OnClickListener() {
                                                    ...
                                                    public void onClick(DialogInterface dialog, int which) {
                                                        ...
                                                        if (which == 1){
                                                            Intent profileIntent = new Intent(getContext(), FacultyMainActivity.class);
                                                            profileIntent.putExtra("visitUserId", userID);
                                                            startActivity(profileIntent);
                                                        }
    ...
    public static class RequestsVH extends RecyclerView.ViewHolder{
        ...
        public RequestsVH(View itemView) {
            ...
            user_photo = itemView.findViewById(R.id.imageViewProfilePictureFaculty);
